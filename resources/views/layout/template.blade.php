    ...
    <div class="container-fluid">
      <div class="row">
          ...
          <div class="col-2 px-1 bg-dark position-fixed" id="sticky-sidebar" style="height:100%;">
                <div class="row pt-5 pl-3">
                  <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="{{url('/data-tagihan')}}">Data Tagihan</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="{{url('/data-pembayaran')}}">Data Pembayaran</a>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div id="navbar" class="col-sm-10">
          <!-- Awal Navbar -->
            <a id="btnLogout" href="{{url('/logout')}}"> <img id="logoutDude" src="{{url('/logout.png')}}"> </a>
          <!-- Akhir Navbar -->
        </div>
